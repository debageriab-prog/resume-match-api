...
public interface ResumeMatchRepository extends JpaRepository<ResumeMatch, Long>, JpaSpecificationExecutor<ResumeMatch> {
	...
	long countByDecisionIsNotNullAndDecisionNot(String decision);

	long countByDecisionIsNotNullAndDecisionNotAndMatchedAtBetween(String decision, Instant start, Instant end);
